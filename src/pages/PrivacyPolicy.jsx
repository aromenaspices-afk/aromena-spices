  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: 'عند إنشاء حساب أو تقديم طلب، نجمع: الاسم الكامل، البريد الإلكتروني، رقم الهاتف، عنوان الشّحن، ومعلومات الدفع (عبر بوابة iyzico الآمنة). كما نجمع بيانات الاستخدام مثل عناوين IP وملفات تعريف الارتباط.',
      },
      {
        title: '3. استخدام المعلومات',
        text: 'نستخدم معلوماتك لمعالجة الطّلبات والتواصل معك بشأنها، وتحسين خدماتنا، وإرسال العروض والتحديثات (بموافقتك). لن نبيع أو نشارك معلوماتك مع أطراف ثالثة دون موافقتك الصريحة.',
      },
      {
