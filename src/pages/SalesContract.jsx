...
const content = {
  ar: {
    ...
    sections: [
      ...
      { title: '2. موضوع العقد', text: 'يتعلق هذا العقد بشراء المنتجات الغذائية (البهارات والتوابل) المعروضة على الموقع الإلكتروني لـ Aromena Spices وتسليمها للمشتري وفق الشّروط المذكورة.' },
      { title: '3. سعر المنتج والدفع', text: 'الأسعار المعروضة شاملة للضرائب المطبقة. يتم الدفع عبر بوابة الدفع الآمنة iyzico. لن يتم شحن الطّلب إلا بعد تأكيد الدفع الكامل.' },
      { title: '4. التسليم', text: 'يتم التسليم إلى العنوان المحدد عند الطّلب. المدة المتوقعة: 5-10 أيام عمل. يتحمل البائع مسؤولية المنتج حتى وصوله سليماً للعميل.' },
      ...
      { title: '6. استثناءات حق العدول', text: 'لا يسري حق العدول على المنتجات الغذائية التي تمَّ فتحها بعد التسليم، نظراً لطبيعتها كمواد غذائية سريعة التلف.' },
