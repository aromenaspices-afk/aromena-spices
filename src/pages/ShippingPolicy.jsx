...
const content = {
  ar: {
    ...
    sections: [
      { title: '1. مناطق الشحن', text: 'نشحن إلى أوروبا (ألمانيا، هولندا، بلجيكا، النمسا وغيرها)، دول الخليج العربي، تركيا، والأردن.' },
      ...
      { title: '3. تكلفة الشحن', text: 'تكلفة الشحن تظهر عند إتمام الطلب بناءً على وجهة التسليم. الشحن مجاني على الطلبات التي تتجاوز قيمتها الحد المحدد لكل منطقة.' },
      { title: '4. سياسة الإرجاع', text: 'يمكنك إرجاع المنتجات خلال 14 يوماً من تاريخ الاستلام، شريطة أن تكون في حالتها الأصلية وغير مفتوحة. تكلفة الشحن العكسي تقع على عاتق العميل ما لم يكن المنتج تالفاً أو مغلوطاً.' },
      { title: '5. المنتجات الغذائية المفتوحة', text: 'لأسباب صحية وسلامة غذائية، لا يمكن قبول إرجاع المنتجات الغذائية التي تم فتحها بعد الاستلام.' },
      ...
      { title: '7. إخلاء مسؤولية الحساسية', text: 'منتجاتنا بهارات طبيعية قد تحتوي على مسببات حساسية. يتحمل المستهلك مسؤولية قراءة المكونات قبل الاستخدام. Aromena Spices غير مسؤولة عن أي تفاعلات حساسية ناتجة عن عدم قراءة المكونات.' },
